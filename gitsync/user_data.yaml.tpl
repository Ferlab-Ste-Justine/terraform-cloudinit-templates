...
%{ if install_dependencies ~}
  #Install gitsync
  - curl -L https://github.com/Ferlab-Ste-Justine/gitsync/releases/download/v0.2.0/gitsync_0.2.0_linux_amd64.tar.gz -o /tmp/gitsync_0.2.0_linux_amd64.tar.gz
  - mkdir -p /tmp/gitsync
  - tar zxvf /tmp/gitsync_0.2.0_linux_amd64.tar.gz -C /tmp/gitsync
  - cp /tmp/gitsync/gitsync /usr/local/bin/${naming.binary}
  - rm -rf /tmp/gitsync
  - rm -f /tmp/gitsync_0.2.0_linux_amd64.tar.gz
%{ endif ~}
